    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="pt-40 pb-16 px-8 md:px-20 border-b border-white/10">
        ...
        <p className="mt-6 text-white/40 text-sm max-w-xl leading-relaxed">
          We&apos;d love to hear from you. Whether you&apos;re planning a wedding, exploring custom design,
          or simply curious about our atelier — write to us, call us, or stop by our boutique in Sinking Spring.
        </p>
      </section>
              ...
              <form onSubmit={submit} className="space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Tell us a little about your wedding, the look you have in mind, or any questions for our team..."
          ...
          <div className="space-y-12">
            <div>
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                href="https://www.google.com/maps/search/?api=1&query=4054+W+Penn+Ave+Sinking+Spring+PA+19608"
                target="_blank"
                rel="noopener noreferrer"
                className="mt-4 inline-block text-xs tracking-widest uppercase text-amber-300/60 hover:text-amber-300 transition-colors"
              >
                Get Directions →
              </a>
            </div>
            ...
            <div>
              ...
              <p className="mt-5 text-xs text-white/30 leading-relaxed">
                Bridal consultations and fittings are by appointment.

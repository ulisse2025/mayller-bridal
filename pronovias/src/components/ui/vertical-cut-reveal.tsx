...
interface TextProps {
  ...
  reverse?: boolean
  transition?: AnimationOptions & { delay?: number; stiffness?: number; damping?: number }
  ...
  (
    ...
    const splitIntoCharacters = (t: string): string[] => {
      if (typeof Intl !== "undefined" && "Segmenter" in Intl) {
        const segmenter = new (Intl as typeof Intl & { Segmenter: new (locale: string, options: object) => { segment: (t: string) => Iterable<{ segment: string }> } }).Segmenter("en", { granularity: "grapheme" })
